...
export default function AboutUsSection() {
    return (
        <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-4 max-w-lg">
                        <div className="flex flex-row justify-center md:justify-start">
                            <div className="w-fit relative">
                                ...
                                <Underline1
                                    className="text-neutral-700 w-full h-auto absolute -bottom-3 left-0 z-0 opacity-80"/>
                                <Star1 className="text-sky-400 w-8 h-8 absolute -right-7 -top-5"/>
                                <Star1
                                    className="text-amber-500 w-5 h-6 absolute -right-10 -top-0 rotate-3 -scale-x-100"/>
                            </div>
                        </div>
            ...
            <div className="flex justify-center items-center bg-[#08182D]">
                <div id="come-join-us" className="w-full h-auto my-4">
                    <h1 className="text-4xl font-bold text-[#FED571] font-rethink text-center">
                        Want to join our camp?
                    </h1>
                </div>
            </div>
        </div>
